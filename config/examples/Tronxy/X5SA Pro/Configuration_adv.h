...
#define ASSISTED_TRAMMING
  ...
  // Define from 3 to 9 points to probe. Note that these locations are the locations of the probe, not the nozzle.
  // It uses the NOZZLE_TO_PROBE_OFFSET value defined in configuration.h to to work out where to put the nozzle.
